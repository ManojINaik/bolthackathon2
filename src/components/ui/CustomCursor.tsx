...
export default function CustomCursor() {
  ...
  useEffect(() => {
    ...
    const onMouseMove = (e: MouseEvent) => {
      ...
      cursorRef.current.style.transform = `translate(${mouseX}px, ${mouseY}px) rotate(${angle}deg)`;
  ...
  return (
    <div ref={cursorRef} className="curzr-arrow-pointer" style={{ opacity: 0, transition: 'opacity 0.3s' }}>
